...
if(isset($_POST['changebtn'])){
    ...
    #geting  old password 
    $pass_qry = pg_query($db,"SELECT password FROM login  WHERE user_id = '$user_id'");
    $pass_data = pg_fetch_assoc($pass_qry);
    //echo($pass_data);
    ...
    $res = pg_query($db,"UPDATE login SET password='$cpassword' WHERE user_id = '$user_id' ");
    #get last insert id
    if ($res) {
